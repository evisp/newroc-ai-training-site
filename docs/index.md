...
!!! info "How to use this site"
    ...
    - Use the practice pages to build one repeatable habit: faster work **without guessing**.
...
- :material-calculator-variant: **Session 3 – AI for estimating workflows**
  - [Overview](sessions/session3/index.md)
  - [Overall document summary](sessions/session3/document-summary.md)
  - [Setup: Projects + custom instructions](sessions/session3/projects.md)
  - [Products + systems summary (with proof)](sessions/session3/products-systems.md)
  - [Estimating Overview — STM](sessions/session3/estimating-overview-stm.md)
  - [Permits / debris / safety: who owns what](sessions/session3/who-owns-what.md)
  - [Exhibit A scope → responsibility + risk](sessions/session3/exhibit-a-risk.md)
  - [Labor model (safe estimating prompt)](sessions/session3/labor-model.md)
