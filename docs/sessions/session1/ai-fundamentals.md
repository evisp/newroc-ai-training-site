...
In this training, **AI is treated as a helper inside tools you already know** (browser, PDF viewer, email, Excel), *not as a new system you have to learn* from scratch.


## What AI is (in simple words)

Think of AI as a **very fast assistant** that has learned from many examples how people write and respond.  
You give it some text and a clear task, and it tries to produce a helpful answer in words, lists, or tables.

Some examples in a construction context:

- Pointing you to likely places in a spec where a requirement is described.  
- Summarising a long email thread into a short list of decisions and open questions.  
- Turning rough notes into clear bullets you can paste into minutes or a log.


## What AI is good at in project work

AI is most useful when the task is about reading, rephrasing, and structuring text.
...
## What AI is not good at (and common pitfalls)

**AI can sound confident even when it is wrong or unsure**.  
Knowing where it struggles helps you use it safely.
...
Because of these limits, **AI is not a source of truth**. It is a **drafting and organising tool** that still needs your judgement.
...
- Asking practical questions about training specs and contracts (e.g., submittal requirements, notice periods).  
- Creating summaries, lists, and tables that make long documents easier to work with.  
- Drafting short emails, notes, or log entries that you then review and adjust.

You stay responsible for what is sent, logged, or agreed.  
AI helps you get to a good draft faster.


## Simple safety and responsibility rules
